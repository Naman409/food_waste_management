...
function Home(props) {
    ...
    return (
        ...
        < div >
            ...
            {/* footer Start */}
            <div style={{ textAlign: "center", backgroundColor: "blueviolet", color: "white", padding: "5px" }}>
                Made
                {/* with <span style={{ fontSize: "30px", color: "red", verticalAlign: "middle" }}>&hearts; </span> */}
                By - Damini Patidar , Gautam Jain , Naman Jain and Naman Shah
            </div>
            {/* footer end */}
            <Snackbar
                anchorOrigin={{
