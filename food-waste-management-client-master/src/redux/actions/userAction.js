...
import { server } from './postsAction';

export const LoginUser = (data, onSuccess) => {
    return async (dispatch, getState) => {
        try {
            const user = await axios.post(`${server}/api/auth/login`, data);
...
export const signupUser = (data, onSuccess) => {
    return async (dispatch, getState) => {
        try {
            const user = await axios.post(`${server}/api/auth/register`, data);
...
export const LoadUser = (onSuccess) => {
    return async (dispatch, getState) => {
        try {
            ...
            const user = await axios.get(`${server}/api/auth/getuser`, {
                headers: {
...
export const updateProfile = (data, onSuccess) => {
    return async (dispatch, getstate) => {
        try {
            ...
            const updatedUser = await axios.put(`${server}/api/auth/update_user`, data, {
                headers: {
                    "authentication": token
                }
            });
